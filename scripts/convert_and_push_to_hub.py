...
# python scripts/convert_and_push_to_hub.py \
# --checkpoint_path "/home/eole/Workspaces/naruto-sd/logs/2022-10-17T10-55-08_naruto/checkpoints/epoch=000071.ckpt" \
# --config_path "configs/stable-diffusion/naruto.yaml" \
# --repo_path "eolecvk/sd-naruto-diffusers"  \
# --output_path "model_zoo/naruto-e0071" \
# --device "cuda:0"
